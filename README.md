...
- [List of selected papers](#List-of-selected-papers) 
...
## Methodology
> Our review follows the guidelines set by the Preferred Reporting Items for System-
atic Review and Meta-Analyses (PRISMA) (Page et al, 2021) approach. This includes
defining a comprehensive article search strategy, establishing inclusion-exclusion cri-
teria, and outlining article selection and data extraction processes. The diagram of PRISMA process is showin in the following figure. 
([Prisma.pdf](https://github.com/user-attachments/files/17708828/Prisma.pdf)
).


## List of selected papers
We list the selected paper in this section. The list will be updated timely manner. 
